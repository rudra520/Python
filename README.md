<!--
  Interactive README for GitHub Repository
  Highlights: AI Sastra (Flagship Project), Assignments, Project by Rudra, Cisco Practice
  Designed with badges, emojis, collapsible sections, and a modern layout.
-->
...
[![License](https://img.shields.io/badge/License--blue?style=for-the-badge&logo=opensourceinitiative)](LICENSE)
...
**AI Sastra** is an ambitious ongoing project that delivers two specialised AI companions:

| Target Audience | Core Focus | Impact |
|:---|:---|:---|
| **Miniloans** (working professionals, daily earners) | 🤖 AI that assists with **workflow optimisation**, financial literacy, task automation, and day‑to‑day productivity. | Reduces cognitive load, boosts efficiency, and simplifies complex tasks. |
